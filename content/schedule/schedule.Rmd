...
- [**Example**](/example/) (<i class="fas fa-laptop-code"></i>): This page contains fully annotated R code and other supplementary information that you can use as a reference for your assignments and project. Given the focus on active learning, we'll evaluate these examples in class together and in groups.
- [**Assignment**](/assignment/) (<i class="fas fa-pencil-ruler"></i>): This page contains the instructions for each assignment. **Assignments are due by 11:59 AM (1 minute before class) on the day they're listed.**

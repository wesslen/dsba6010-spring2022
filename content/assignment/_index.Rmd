...
- ✔: (*90% in gradebook*) Completed provided solutions and made a valid attempt at the non-provided questions. 
- ✔−: (*50% in gradebook*) Assignment is less than 50% complete and/or most answers are incorrect. This indicates that you need to improve next time. I will hopefully not assign these often.
- ✔−−: (*0% in gradebook*) Assignment was not turned in I will hopefully not assign these often.
...
There is no final exam. The final project is your final exam.

[Complete details for the final project are here.](/assignment/final-project/)

### Scope

Projects can cover anything related to Bayesian inference. We'll cover a range of applications in Bayesian inference for [check-in assigment 1](/assignment/class-presentation/) and students are encouraged to think outside of the box. As mentioned in the syllabus, students may use programming language outside of R/Stan for this project (e.g., Turing.jl, PyMC).

### Check-in assigments

For your [final project](/assignment/final-project/), you will have two check-in projects. 

The first check-in is an [in-class presentation](/assignment/class-presentation/) on February 14th. Presentations will be done individually and can be 5-10 minutes long. Students may present in class or digitally (e.g., .mp4 video). If students choose to upload digitally, the document must be submitted at 11:59am of February 14th.

The second check-in will be a [project proposal](/assignment/project-proposal/) due on February 28th. This will need to be turned in on Canvas. 

Similar to problem sets, late assignments (within 24 hours) will be subject to a 50% reduction. Assignments received over 24 hours will be subject to a zero grade. 
...
- ✔: (*100% in gradebook*) Document/presentation is easy to follow and the work (generally) met the requirements. **This is the expected level of performance.**

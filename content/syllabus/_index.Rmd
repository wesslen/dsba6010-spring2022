...
### Rewards from taking this course
...
To encourage engagement with the course content—and to allow me to collect the class's questions each week—you'll need to fill out a [short response on Google Forms](https://forms.gle/zMipNzav3BCL3Rwy9).
...
2. **Participation**: Students will receive 5% of their grade based on participation. While I will not actively take attendance, this will be in large part a function of in-class participation (e.g., asking/answering questions, weekly check-ins) as well as out-of-class (e.g., Slack).

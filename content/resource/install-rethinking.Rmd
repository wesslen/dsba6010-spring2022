...
<script src="/js/prismr.js"></script>
...
You can find more information about `rstan`  <https://mc-stan.org/users/interfaces/rstan.html> or you can view the [Stan User Guide](https://mc-stan.org/docs/2_28/stan-users-guide/index.html).
...
```{r}
# this uses cmdstanr version; this is recommended

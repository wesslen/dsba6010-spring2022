...
This resource was created by Andrew Heiss for his [PMAP 8521 course](https://evalf21.classes.andrewheiss.com/resource/). I liked it so much, that I kept it without modification. Some of the topics will be covered in the class while others won't in much detail (e.g., `brms`, ROPE). His course focuses more on causal inference (which we'll cover a little) but only some coverage of Bayesian Statistics. Nevertheless, Andrew is a great communicator of Bayesian stats in practice (see [blog post 1](https://www.andrewheiss.com/blog/2021/11/08/beta-regression-guide/), [blog post 2](https://www.andrewheiss.com/blog/2021/12/01/multilevel-models-panel-data-guide/)) and we'll likely reference some of his work later on.
...
[In session 6](https://evalf21.classes.andrewheiss.com/content/06-content/), we talked about frequentist confidence intervals and Bayesian credible (or posterior) intervals, since I had you read [Guido Imbens's essay on *p*-values](https://doi.org/10.1257/jep.35.3.157), where his conclusion is that:
